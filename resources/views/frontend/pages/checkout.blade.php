    ...
    <section class="checkout-div-1">
        ...
        <div class="checkout-div-2">
            ...
            <div class="returning-div">
                            ...
                            <!-- <h3 class="returning-cust">Have a coupon? -->
                                <h3 class="returning-cust">Have a coupon?</h3>
                            <form action="{{route('coupon-store')}}" method="post">
                                <input type="text" class="promo" placeholder="Coupon code">
                                <button type="submit" class="promo-btn">Apply</button>
                            </form>
                                 <!-- <a href="javascript:" style="color:#226ce0">Click here to enter your code</h3></a> -->
                            @if(session('coupon'))
                                <li class="coupon_price" data-price="{{session('coupon')['value']}}">You Save<span>${{number_format(session('coupon')['value'],2)}}</span></li>
                            @endif
                        </div>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <!-- <div class="returning-div">
                            ...
                            <h3 class="returning-cust">Returning customer? <a href="javascript:"
                                    style="color:#226ce0">Click here to login</h3></a>
                        </div> -->
                        <div class="checkout-form">
                    ...
                    <div class="col-md-5">
                        ...
                        <div>
                            <p class="privacy-policy">Your personal data will be used to process your order, support
                                your experience throughout this website, and for other purposes described in our <a style="color:#007bff" href="javsacript:">privacy
                                policy.</a></p>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="flexRadioDefault10"
                                    id="flexRadioDefault10" value="">
                                <label class="form-check-label create-acc1" for="flexRadioDefault10">
                                    I have read and agree to the website <a style="color:#007bff" href="javsacript:">terms and conditions*</a>
                                </label>
                            </div>
                            <button type="submit" class="place-an-order">Place an order</button>
                        </div>
                    </div>
                </div>
            </form>
